...
int RunScriptWithGlobals(napi_env env, const char* source_text, const char* entry_script_path, std::string* error_out) {
  ...
  static const char kPrelude[] =
      ...
      "    if (!globalThis.process.stdin || !globalThis.process.stdin.isTTY) globalThis.process.stdin = new __tty.ReadStream(0);"
      "    if (!globalThis.process.stdout || !globalThis.process.stdout.isTTY) globalThis.process.stdout = new __tty.WriteStream(1);"
      "    if (!globalThis.process.stderr || !globalThis.process.stderr.isTTY) globalThis.process.stderr = new __tty.WriteStream(2);"
      "  } catch (_) {"
